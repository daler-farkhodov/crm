...
type ClassOption = { id: string; name: string; pricePerMonth: number };
...
export function EnrollToClassModal({ studentId, classes, action }: Props) {
        ...
        >
          <div className="relative w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl dark:border-slate-600 dark:bg-slate-900">
            ...
            <p className="mb-6 text-sm text-slate-500 dark:text-slate-400">
              Select a class and start date to enroll this student.
            </p>
            ...
            <form action={formAction} className="grid gap-4">
              ...
              <div>
                <Label>Class</Label>
                <select name="classId" required className={selectCls}>
                  {classes.map((c) => (
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <Submit variant="orange" disabled={pending}>
